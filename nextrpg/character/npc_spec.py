...
from typing import TYPE_CHECKING, Any, Generator, Self, override
...
class EventSpec(UpdateFromSave[dict[str, Any]]):
    ...
    generator: Callable[..., Generator[RpgEventScene, Any, None]] = default(
        lambda self: transform_event(self.event)
    )
