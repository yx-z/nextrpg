...
class MapMove:
    to_object: str
    from_object: str
    to_scene: Callable[[PlayerSpec, GameState], MapScene]

    def move_to_scene(
        self, from_scene: MapScene, player: PlayerOnScreen, state: GameState
        ...
        scene = TransitionScene(to_scene)
        return scene, state
