...
class TestLoggerMessages:
    ...
    @pytest.mark.skip(
        reason="Complex logging infrastructure, requires full config setup"
    )
...
class TestLogEntry:
    ...
    def test_log_entry_creation(self):
        ...
        entry = LogEntry(
            component="test", level=LogLevel.INFO, message="test message"
        )
    ...
    def test_log_entry_with_template(self):
        ...
        entry = LogEntry(
            component="test", level=LogLevel.DEBUG, message=template
        )
    ...
    def test_log_entry_formatted_with_message_key_and_drawing(self):
        ...
        msg_and_drawing = MessageKeyAndDrawing(
            message_key="key1", drawing=mock_drawing
        )
        entry = LogEntry(
            component="test", level=LogLevel.INFO, message=msg_and_drawing
        )
...
class TestMessageKeyAndDrawing:
    ...
    def test_message_key_and_drawing_creation(self):
        ...
        mock_drawing = MagicMock()
        msg_drawing = MessageKeyAndDrawing(
            message_key="key1", drawing=mock_drawing
        )
...
class TestAddFunction:
    ...
    @pytest.mark.skip(
        reason="Requires full config infrastructure and side effects"
    )
...
class TestLogEntryImmutability:
    ...
    def test_log_entry_is_frozen_dataclass(self):
        ...
        entry = LogEntry(component="test", level=LogLevel.INFO, message="test")
