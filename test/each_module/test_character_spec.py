...
class TestCharacterSpec:
    ...
    def test_character_spec_creation(self):
        ...
        with patch("nextrpg.config.config.config") as mock_config:
            ...
            drawing = MagicMock()
            spec = CharacterSpec(unique_name="hero", character_drawing=drawing)
    ...
    def test_character_spec_with_avatar(self):
        ...
        with patch("nextrpg.config.config.config") as mock_config:
            ...
            avatar = MagicMock()
            spec = CharacterSpec(
                unique_name="hero", avatar=avatar, character_drawing=drawing
            )
    ...
    def test_character_spec_custom_config(self):
        ...
        spec = CharacterSpec(
            unique_name="hero", character_drawing=drawing, config=behavior
        )
...
class TestPlayerSpec:
    ...
    def test_player_spec_creation(self):
        ...
        with patch("nextrpg.config.config.config") as mock_config:
            ...
            drawing = MagicMock()
            spec = PlayerSpec(unique_name="player", character_drawing=drawing)
    ...
    def test_player_spec_inherits_from_character_spec(self):
        ...
        with patch("nextrpg.config.config.config") as mock_config:
            ...
            drawing = MagicMock()
            player = PlayerSpec(unique_name="player", character_drawing=drawing)
