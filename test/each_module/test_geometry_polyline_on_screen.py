...
class TestPolylineProperties:
    ...
    @pytest.mark.skip(reason="_bounding_rectangle_area requires rectangle_area_on_screen")
...
class TestPolylineIntegration:
    ...
    def test_polyline_points_can_be_scaled(self):
        ...
        assert scaled_polyline.length == pytest.approx(polyline.length * 2, rel=0.01)
